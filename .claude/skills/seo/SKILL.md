...
**Runtime:** Run bundled Python tools through `.claude/skills/seo/bin/.claude/skills/seo/bin/claude-seo run <script.py>`. Plugin
...
3. If Google API credentials detected (`.claude/skills/seo/bin/.claude/skills/seo/bin/claude-seo run google_auth.py --check`), also spawn seo-google agent
...
6. If backlink APIs detected (`.claude/skills/seo/bin/.claude/skills/seo/bin/claude-seo run backlinks_auth.py --check`), also spawn seo-backlinks agent
...
10. If drift baseline exists for this URL (`.claude/skills/seo/bin/.claude/skills/seo/bin/claude-seo run drift_history.py <url>`), also spawn seo-drift agent
